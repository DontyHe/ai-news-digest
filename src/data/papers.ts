...
export default papers;  {
  ...
  {
    id: "jit-2026-06-22",
    title: "Back to Basics: Let Denoising Generative Models Denoise (JiT)",
    authors: "Tianhong Li, Kaiming He",
    date: "2026-06-22",
    institution: "MIT",
    category: "ai",
    summary: "Today's diffusion models predict noise/noised quantities rather than clean images. This paper argues predicting clean data is fundamentally different per manifold assumption. Simple large-patch Transformers on pixels (JiT) achieve competitive results on ImageNet 256/512 with no tokenizer, no pre-training, no extra loss.",
    background: "Denoising diffusion models don't denoise in classical sense; they predict noise. Predicting clean vs noised quantities are fundamentally different due to manifold assumption.",
    architecture: "Just image Transformers (JiT): large-patch Transformers operating directly on pixels for diffusion, no tokenizer needed.",
    innovations: "Direct clean data prediction, competitive results without tokenizers/pre-training/auxiliary losses, patch sizes 16 and 32 on ImageNet",
    inspiration: "Back to basics approach: manifold assumption for generative modeling.",
    pdfUrl: "https://arxiv.org/pdf/2511.13720",
    htmlUrl: "https://arxiv.org/abs/2511.13720",
    figures: []
  },
  {
    id: "leworldmodel-2026-06-22",
    title: "LeWorldModel: Stable End-to-End JEPA from Pixels",
    authors: "Lucas Maes, Quentin Le Lidec, Damien Scieur, Yann LeCun, Randall Balestriero",
    date: "2026-06-22",
    institution: "Mila, NYU, Samsung SAIL, Brown University",
    category: "worldmodel",
    summary: "First JEPA training stably end-to-end from raw pixels with only 2 loss terms. 15M params, single GPU, plans 48x faster than foundation-model-based world models. Competitive across 2D/3D control tasks.",
    background: "Existing JEPAs rely on complex multi-term losses, EMAs, pre-trained encoders, or auxiliary supervision to avoid collapse.",
    architecture: "JEPA with next-embedding prediction loss + Gaussian regularizer. Reduces tunable hyperparameters from 6 to 1.",
    innovations: "First stable end-to-end JEPA from pixels, 2-term loss, 48x faster planning, latent space encodes physical structure",
    inspiration: "World model simplicity and efficiency for embodied AI planning.",
    pdfUrl: "https://arxiv.org/pdf/2603.19312",
    htmlUrl: "https://arxiv.org/abs/2603.19312",
    figures: []
  },
  {
    id: "lejepa-identifiability-2026-06-22",
    title: "When Does LeJEPA Learn a World Model?",
    authors: "David Klindt, Yann LeCun, Randall Balestriero",
    date: "2026-06-22",
    institution: "Cold Spring Harbor Lab, NYU, Brown University",
    category: "worldmodel",
    summary: "Proves LeJEPA linearly recovers world latent variables from nonlinear observations (linear identifiability). Gaussian is unique distribution for this guarantee. All proofs verified in Lean 4.",
    background: "Need mathematical guarantees for when JEPA-style models learn true world structure.",
    architecture: "LeJEPA with alignment + Gaussian regularization. Theoretical analysis of identifiability.",
    innovations: "Linear identifiability proof, Gaussian uniqueness theorem, Lean 4 verified proofs, optimal latent-space planning guarantee",
    inspiration: "Mathematical foundations for world model reliability and planning.",
    pdfUrl: "https://arxiv.org/pdf/2605.26379",
    htmlUrl: "https://arxiv.org/abs/2605.26379",
    figures: []
  }
];
