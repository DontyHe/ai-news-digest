...
export const papers: Paper[] = [
  {
    ...
    institution: "MARS Lab NTU, PKU, BAAI, HKUST(GZ)",
    date: "2026-08-06",
    category: "worldmodel",
    summary: "首个面向人形机器人并发移动操作的潜在预测式世界动作模型。通过轻量级未来视觉潜在预测与基于扩散的全身动作生成耦合，实现边走边操作。附带 ω-HOME 40+小时真实数据集。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.06375v1",
    htmlUrl: "https://arxiv.org/html/2608.06375v1",
    figures: []
  },
  {
    id: "geniworld-2026-08-06",
    title: "GeniWorld: 基于视觉动作的通用交互世界模型",
    authors: "Chenghao Gu, Hanyang Yu, Jingbo Zhang, Haitao Lin, et al.",
    institution: "Tsinghua SIGS, Tencent Robotics X, HKUST",
    date: "2026-08-06",
    category: "worldmodel",
    summary: "通过URDF渲染将数值动作转换为视觉动作，解耦具身运动学与环境动态建模，零样本跨场景泛化强。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.06332v1",
    htmlUrl: "https://arxiv.org/html/2608.06332v1",
    figures: []
  },
  {
    id: "dypes-vla-2026-08-06",
    title: "DyPES-VLA: 跨具身共享动力学先验与特定控制",
    authors: "Junfeng Li, Junjie He, Zhide Zhong, et al.",
    institution: "HKUST(GZ), COCO Matrix",
    date: "2026-08-06",
    category: "vla",
    summary: "学习共享动力学先验和具身特定控制的跨具身VLA。MoE动作头在原生动作空间生成控制。LIBERO 98.0%。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.06374v1",
    htmlUrl: "https://arxiv.org/html/2608.06374v1",
    figures: []
  },
  {
    id: "dreamwam-2026-08-05",
    title: "DreamWAM: 超越RGB预测的世界动作模型",
    authors: "Shanglin Yuan, Weiheng Zhao, Xin Shi, et al.",
    institution: "HUST, ByteDance Seed",
    date: "2026-08-05",
    category: "worldmodel",
    summary: "将WAM未来预测扩展为外观+运动+几何+语义四视角，推理零额外开销。LIBERO-Plus扰动下提升12%。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.04996v1",
    htmlUrl: "https://arxiv.org/html/2608.04996v1",
    figures: []
  },
  {
    id: "xeworld-2026-08-06",
    title: "XEWorld: 动作条件化世界模型跨具身泛化测试",
    authors: "Yixiang Chen, Jiabing Yang, Yuan Xu, et al.",
    institution: "CAS NLPR, UCAS",
    date: "2026-08-06",
    category: "worldmodel",
    summary: "系统测试揭示当前世界模型本质上是2D视觉模式匹配器，泛化由视觉相似性而非物理运动学决定。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.05799v1",
    htmlUrl: "https://arxiv.org/html/2608.05799v1",
    figures: []
  },
  {
    id: "lilawam-2026-08-04",
    title: "LiLa-WAM: 轻量级潜在推理世界动作模型",
    authors: "Fan Yang, Yuting Su, Xiaobo Wang, et al.",
    institution: "Tianjin University, Mininglamp Technology",
    date: "2026-08-04",
    category: "worldmodel",
    summary: "单24GB GPU可训练的轻量WAM。DINOv3+VTT无语言任务指定。RoboTwin 2.0 50任务 90.48%。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.03701v1",
    htmlUrl: "https://arxiv.org/html/2608.03701v1",
    figures: []
  },
  {
    id: "bridgevla2-2026-08-05",
    title: "BridgeVLA++: 记忆增强的3D VLA框架",
    authors: "Peiyan Li, Yuze Zhu, Yixiang Chen, et al.",
    institution: "CAS NLPR, UCAS, FiveAges, ByteDance Seed",
    date: "2026-08-05",
    category: "vla",
    summary: "统一时空记忆架构：时间记忆推理做什么，空间记忆恢复遮挡确定在哪里做。记忆任务20%→93.3%。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.05042v1",
    htmlUrl: "https://arxiv.org/html/2608.05042v1",
    figures: []
  },
  {
    id: "hiroc-2026-08-06",
    title: "HiRoC: 层次化VLA后训练框架",
    authors: "He Kong, Zengjue Chen, Qi Wang, et al.",
    institution: "CAS ICT",
    date: "2026-08-06",
    category: "vla",
    summary: "Planner(SFT)分解子目标→Executor(子目标SFT对齐→在线GRPO RL)。多基准平均提升10.06%。",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
    pdfUrl: "https://arxiv.org/pdf/2608.05999v1",
    htmlUrl: "https://arxiv.org/html/2608.05999v1",
    figures: []
  },
  {
    id: "wcm-2026-08-06",
