...
export const papers: Paper[] = [
  {
    id: "handoff-2026-06-08",
    title: "HANDOFF: 人形机器人任务空间全身控制——蒸馏互补教师网络",
    authors: "Chong Ma, Taiyi Su, Jian Zhu, et al.",
    institution: "同济大学 / 美的集团 AIRC",
    date: "2026-06-08",
    category: "embodied",
    summary: "提出10维任务空间命令接口，通过多教师KL蒸馏与上下文条件门控的MoE学生网络，实现单一通用人形全身控制器，无需密集运动学参考即可被VLM驱动的任务规划器直接调用。",
    background: "现有方法依赖密集运动学参考轨迹，高层任务规划器难以直接调用和控制人形机器人。",
    architecture: "VLM任务规划器 + 10维任务空间接口 + MoE全身控制器三层架构，上下文条件门控动态选择专家知识。",
    innovations: "1) VLM可直接调用的10维任务空间命令接口；2) 多教师KL蒸馏框架；3) 上下文条件门控的MoE架构。",
    inspiration: "层次化接口设计思路，VLM负责决策、专业控制器负责执行，平衡了表达能力与控制效率。",
    pdfUrl: "https://arxiv.org/pdf/2606.06493",
    htmlUrl: "https://arxiv.org/abs/2606.06493",
    figures: []
  },
  {
    id: "tempovla-2026-06-08",
    title: "TempoVLA: 可控速 Vision-Language-Action 策略学习",
    authors: "Taiyi Su, Chong Ma, Jian Zhu, et al.",
    institution: "同济大学 / 美的集团 AIRC",
    date: "2026-06-08",
    category: "vla",
    summary: "通过数据端VSTA轨迹重定时增强和模型端速度条件注入，让单一VLA支持0.25x-2x双向显式速度控制，可与VLM调度器配合实现场景自适应的动态速度规划。",
    background: "现有VLA模型缺乏显式速度控制能力，不同任务场景需要不同运动速度但需要多个独立模型。",
    architecture: "VSTA数据管道 + 速度编码器 + FiLM速度条件注入层，VLM调度器输出速度指令令牌。",
    innovations: "1) VLA中首个双向速度控制；2) VSTA轨迹重定时数据增强；3) FiLM机制实现平滑速度过渡。",
    inspiration: "动作幅度直接决定速度的观察值得重视；条件注入实现单一模型多功能是高效的工程实践。",
    pdfUrl: "https://arxiv.org/pdf/2606.06491",
    htmlUrl: "https://arxiv.org/abs/2606.06491",
    figures: []
  },
  {
    id: "wla-2026-06-08",
    title: "WLA: World Model-Assisted Learning for Generalizable Manipulation Policies",
    authors: "et al.",
    institution: "待确认",
    date: "2026-06-08",
    category: "worldmodel",
    summary: "利用世界模型预测动作执行结果来扩充训练数据分布，增强VLA策略在分布外场景（特别是新物体和新场景）中的泛化能力。",
    background: "行为克隆受限于演示数据的分布，新物体/新场景中性能下降明显。",
    architecture: "世界模型(潜变量视频扩散) + 动作优化器(潜空间梯度下降) + 策略学习器，置信度加权防止误差累积。",
    innovations: "1) 系统性研究世界模型合成数据对VLA泛化的影响；2) 潜空间动作优化；3) 置信度加权机制。",
    inspiration: "世界模型作为数据生成器的范式，可在数据稀缺场景中实现策略-世界模型协同进化。",
    pdfUrl: "https://arxiv.org/pdf/2606.05979",
    htmlUrl: "https://arxiv.org/abs/2606.05979",
    figures: []
  },
  {
    id: "pil-world-2026-06-08",
    title: "PiL-World: VLA策略在环评估的分块世界模型",
    authors: "Chong Ma, Taiyi Su, Jian Zhu, et al.",
    institution: "同济大学 / 美的集团 AIRC",
    date: "2026-06-08",
    category: "worldmodel",
    summary: "针对VLA闭环评估场景设计的世界模型，通过动作到视觉控制投影、多视角联合预测和潜在历史记忆，实现无需真实机器人即可评估VLA策略的可靠闭环仿真。",
    background: "现有世界模型多为开环设计，无法支持策略在环的VLA评估需求。",
    architecture: "动作到视觉控制投影 + 潜变量视频扩散 + 多视角历史记忆，两阶段训练（通用预训练+任务微调）。",
    innovations: "1) 首个VLA策略在环评估的闭环世界模型；2) 动作到视觉控制投影解决模态鸿沟；3) 成功/失败轨迹联合训练。",
    inspiration: "世界模型从预测工具提升为评估工具，两阶段训练策略可直接复用。",
    pdfUrl: "https://arxiv.org/pdf/2606.05773",
    htmlUrl: "https://arxiv.org/abs/2606.05773",
    figures: []
  },
  {
    id: "affordancevla-2026-06-08",
    title: "AffordanceVLA: 通过可负担性感知理解赋能动作生成的VLA",
    authors: "Qize Yu, Jiadi You, Yuran Wang, et al.",
    institution: "北京大学 / 香港科技大学(广州) / 香港中文大学",
    date: "2026-06-08",
    category: "vla",
    summary: "引入结构化affordance预测(Which2Act/Where2Act/How2Act)作为中间表示，通过多专家混合Transformer和三阶段训练策略，弥合VLM语义空间与具身控制策略之间的结构鸿沟。",
    background: "VLM语义空间与具身控制物理动作空间之间存在根本性的结构不匹配。",
    architecture: "MoT架构(Understanding/Affordance/Action三专家) + UAA渐进注意力 + 三阶段训练(通用预训练/协同训练/任务微调)。",
    innovations: "1) 三层结构化affordance预测(Which/Where/How)；2) 混合专家Transformer；3) affordance一致性损失。",
    inspiration: "中间表示设计可解耦感知/推理/执行便于独立验证，三阶段训练流程可直接参考。",
    pdfUrl: "https://arxiv.org/pdf/2606.06155",
    htmlUrl: "https://arxiv.org/abs/2606.06155",
    figures: []
  },
  {
    id: "mpcot-2026-06-08",
    title: "MPCoT: 奖励引导多路径潜在推理实现VLA测试时可扩展",
    authors: "Boyang Zhang, Lianlei Shan",
    institution: "波士顿大学 / 清华大学",
    date: "2026-06-08",
    category: "vla",
    summary: "在VLA连续潜空间内进行多假设初始化、多步迭代修正和奖励引导路径评分的潜在推理框架，无需生成推理token即实现测试时深度/宽度可调的VLA能力提升。",
    background: "单次动作解码推理深度不足导致长期任务失败，显式CoT引入token延迟和间接接口。",
    architecture: "M个假设初始化 + K步权重共享MLP精化 + 奖励引导路径评分器 + 置信度加权聚合。",
    innovations: "1) 测试时深度/宽度均可调节的推理能力；2) 奖励引导路径评分器；3) 保持原始action接口兼容性。",
    inspiration: "计算预算动态分配策略可用，工程中简单任务低预算、复杂任务高预算。",
    pdfUrl: "https://arxiv.org/pdf/2606.06245",
    htmlUrl: "https://arxiv.org/abs/2606.06245",
    figures: []
  },
  {
    id: "thinking-with-imagination-2026-06-08",
    title: "Thinking with Imagination: 通过世界模拟器实现智能体视觉空间推理",
    authors: "Chenming Zhu, Jingli Lin, Yilin Long, et al.",
    institution: "香港大学 / 上海AI实验室 / 上海交大 / 复旦大学 / 北航",
    date: "2026-06-08",
    category: "vla",
    summary: "Astra框架让VLM主动查询action-conditioned world simulator获取novel-view imagined observations，在推理过程中动态获取缺失的空间证据。",
    background: "当前VLMs难以从不完整egocentric观测中推断未观察布局，缺乏「想象力」。",
    architecture: "Astra-VL(Qwen3-VL agentic推理) + Astra-WM(Bagel世界模拟器) + View Consistency Tuning + 两阶段RL课程。",
    innovations: "1) 想象力形式化为VLM与world simulator的主动交互；2) View Consistency Tuning；3) 两阶段RL课程教选择性想象。",
    inspiration: "主动信息获取能力可能比单纯增加模型规模更有效，两阶段RL保持on-policy分布的设计值得借鉴。",
    pdfUrl: "https://arxiv.org/pdf/2606.06476",
    htmlUrl: "https://arxiv.org/abs/2606.06476",
    figures: []
  },
  {
  ...
  },
  {
    ...
    date: "2026-04-08",
    category: "embodied",
    summary: "# ArXiv具身智能/VLA/世界模型论文追踪 - 2026-06-01  ## 概述 本文档追踪过去7天（2026-05-25至2026-06-01）发布在arXiv上的具身智能/VLA/世界模型相关研究论文。  ---  ## 论文1: DIAL: Decoupling Intent and Action via Latent World Modeling for End-to-End VL",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-04-08",
    category: "embodied",
    summary: "## 2. Action Images: 通过多视角视频生成实现端到端策略学习  - **论文ID**: arXiv:2604.06168 - **作者**: Zixian Gao, Qiao Sun, Yilin Zhao, Yuncong Yang, Yilun Du, Tsun-Hsuan Wang, Yi-Ling Qiao, Chuang Gan - **机构**: UMass Amhe",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-21",
    category: "embodied",
    summary: "## 1. FASTER: Rethinking Real-Time Flow VLAs  - **论文ID**: arXiv:2603.19199 - **作者**: Yuxiang Lu, Zhe Liu, Xianzhe Fan, Zhenya Yang, Jinghua Hou, Junyi Li, Kaixin Ding, Hengshuang Zhao - **机构**: 悉尼大学 /",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-21",
    category: "embodied",
    summary: "## 3. V-Dreamer: Automating Robotic Simulation and Trajectory Synthesis via Video Generation Priors  - **论文ID**: arXiv:2603.18811 - **作者**: Songjia He, Zixuan Chen, Hongyu Ding, Dian Shao, Jieqi Shi, ",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-19",
    category: "embodied",
    summary: "## 4. Fast-WAM: 世界动作模型真的需要推理时未来想象吗?  **论文ID:** arXiv:2603.16666 **作者:** Tianyuan Yuan, Zibin Dong, Yicheng Liu, Hang Zhao **机构:** Tsinghua University (Hang Zhao 组) **日期:** 2026-03-17 (v1), 2026-03-23 ",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-17",
    category: "embodied",
    summary: "## 6. Planning in 8 Tokens: A Compact Discrete Tokenizer for Latent World Model  - **论文ID**: arXiv:2603.05438 - **作者**: Dongwon Kim, Gawon Seo, Jinsung Lee, Minsu Cho, Suha Kwak - **机构**: 暂未明确 - **发布日",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-16",
    category: "embodied",
    summary: "### 1. Ψ0: 人形机器人基础模型 **论文ID**: arXiv:2603.12263v1   **作者**: Songlin Wei, Hongyi Jing, Boqian Li 等   **机构**: 斯坦福大学、南加州大学   **日期**: 2026年3月22日   **类别**: Robotics, Computer Vision  **一句话概括**: Ψ0是一个开源人形机器",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-16",
    category: "embodied",
    summary: "### 3. VLA模型持续强化学习研究 **论文ID**: arXiv:2603.11653v1   **作者**: Mingming Li, Jiale Yang, Hao Dong 等   **机构**: 北京大学、微软亚洲研究院   **日期**: 2026年3月17日   **类别**: Machine Learning, Reinforcement Learning  **一句话概括*",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-16",
    category: "embodied",
    summary: "### 4. RoboClaw: 持续自主数据收集框架 **论文ID**: arXiv:2603.11558v1   **作者**: Chen Chen, Yifan Sun, Wei Xu 等   **机构**: MIT、UC Berkeley   **日期**: 2026年3月16日   **类别**: Robotics, Machine Learning  **一句话概括**: RoboCl",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-16",
    category: "embodied",
    summary: "## 12. OmniStream: Mastering Perception, Reconstruction and Action in Continuous Streams  - **论文ID**: arXiv:2603.12265 - **作者**: Yibin Yan, Jilan Xu, Shangzhe Di, Haoning Wu, Weidi Xie - **机构**: 伦敦帝国理",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-12",
    category: "embodied",
    summary: "## 8. DynVLA: 世界动力学学习  **论文ID**: arXiv:2603.11041   **作者**: Shuyao Shang, Bing Zhan, Yunfei Yan, Yuqi Wang, Yingyan Li, Yasong An, Xiaoman Wang, Jierui Liu, Lu Hou, Lue Fan, Zhaoxiang Zhang, Tieniu Ta",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-12",
    category: "embodied",
    summary: "## 9. FutureVLA  - **论文ID**: arXiv:2603.10712 - **标题**: FutureVLA: Joint Visuomotor Prediction for Vision-Language-Action Model - **作者**: Xiaoxu Xu, Hao Li, Jinhui Ye, Yilun Chen, Jia Zeng, Xinyi Chen",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-12",
    category: "embodied",
    summary: "## 10. DiT4DiT  - **论文ID**: arXiv:2603.10448 - **标题**: DiT4DiT: Jointly Modeling Video Dynamics and Actions for Generalizable Robot Control - **作者**: Teli Ma, Jia Zheng, Zifan Wang, Chuili Jiang, Andy",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-12",
    category: "embodied",
    summary: "## 12. DepthCache  - **论文ID**: arXiv:2603.10469 - **标题**: DepthCache: Depth-Guided Training-Free Visual Token Merging for Vision-Language-Action Model Inference - **作者**: Yuquan Li, Lianjie Ma, Han Di",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
  ...
  },
  {
    ...
    date: "2026-03-11",
    category: "embodied",
    summary: "# 具身智能论文 Digest - 2026年3月15日  > 更新日期: 2026-03-15 > 关键词: World Model, Embodied AI, VLA, Robotics Foundation Model, End-to-end Robotics  ---  ## 📄 TiPToP: A Modular Open-Vocabulary Planning System for R",
    background: "",
    architecture: "",
    innovations: "",
    inspiration: "",
